#!/usr/bin/env python3
"""Run video tracking through the hand pipeline with Ascend OM models."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", type=Path, default=PROJECT_ROOT / "runs/ascend_video_predictions.jsonl")
